    ...
    >
      <Grid container height="100%">
        <Grid item xs={12} lg={3}>
          <Typography fontSize={isMobile && 50} textAlign={isTablet && "center"} variant="h1" color="primary">
            Souviens <span>Toi</span>
          </Typography>
        </Grid>
        <Grid item xs={12} lg={6}>
          <Stack width="100%" marginX="auto" alignItems="center" justifyContent="center" height="100%" >
            <Paper sx={{ borderRadius: 7, width: "100%", maxWidth: "350px", border: `2px solid ${Theme.palette.primary.main}`, display: "flex", gap: 4, flexDirection: "column", alignItems: "center", justifyContent: "center", p: 2 }}>
              ...
              <Typography display="flex" alignItems="center" gap={1}>
                ...
                <Button onClick={() => setAuth(!auth)} variant="text" color="secondary" to="/notes">{auth ? "Inscription" : "Se connecter"} </Button>
              </Typography>
            </Paper>
          </Stack>
        </Grid>
